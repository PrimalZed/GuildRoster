...
(function () {
    ...
    angular
        ...
        .constant('wowRender', 'https://render-api-us.worldofwarcraft.com/static-render/us/');
})();
                ...
                .then(function (members) {
                    return members.map(function (member) {
                        ...
                        if (member.character.spec) {
                            member.character.spec.iconUrl = "https://us.media.blizzard.com/wow/icons/56/" + member.character.spec.icon + ".jpg";
                        }
